...
![](pages/images/makroskopisch_v5.svg){width=200%}

::: {style="font-size:0.45em; color:#888;"}
...
![](pages/images/microfacet_model.png){width=60%}
...
::: {style="font-size:0.45em; color:#888;"}
Quelle: https://www.mathematik.uni-marburg.de/~thormae/lectures/graphics2/graphics_4_3_ger_web.html#1
:::
...
Diffuser und spekularer Anteil von BRDF:
$$
f_r(\mathbf{v}, \mathbf{l}) = f_d(\mathbf{v}, \mathbf{l}) + f_s(\mathbf{v}, \mathbf{l})
$$

::: {.fragment}
Der spekulare Anteil basiert meist auf dem Cook-Torrance-Modell:
$$
...
- **D · NDF** → Wie konzentriert sind die Mikrofacetten-Normalen?
...
![](pages/images/Fresnel_Effect.jpg){width=80%}
...
- In der Praxis: Schlick-Approximation statt exakter Formel
:::
...
::: {.incremental}
- Beschreibt die Verteilung der Mikrofacetten-Normalen
- Roughness steuert die Streuung
- Glatte Oberfläche → enge Verteilung → scharfe Reflexion
- Raue Oberfläche → breite Verteilung → diffuse Spiegelung
:::

::: {.fragment style="margin-top:25px;"}
→ D bestimmt, wie **konzentriert oder gestreut** die Reflexion wirkt.
:::

::: {.fragment style="margin-top:15px;"}
In der Praxis wird meist **GGX** verwendet –
es erzeugt realistischere, länger auslaufende Glanzlichter als ältere Modelle.
:::
...
![](pages/images/microshadows.png){fig-align="center" width="95%"}
...
::: {style="font-size:0.4em; color:#888;"}
...
| **D** | Wie konzentriert sind die Reflexionen? |
...
$$
f_s =
\frac{F \cdot D \cdot G}
{4(n\cdot l)(n\cdot v)}
$$

::: {.fragment style="text-align:center; margin-top:30px; font-size:1.2em;"}
...
::: {.fragment}
- Diffuse und Specular sind unabhängig voneinander
:::

::: {.fragment}
::: {style="font-family: monospace; background:#f0f0f0; padding:10px; font-size:0.8em;"}
Diffuse  = 0.8  
Specular = 0.8  
→ 160 % Reflexion
:::
...
::: {.fragment}
→ Mehr Spiegelung bedeutet automatisch weniger Diffusion – Energie bleibt erhalten.
:::
...
- NDF beschreibt die Konzentration der Reflexion
...
→ Diese Prinzipien stecken in jedem modernen Materialshader –
von Unreal über Blender bis Unity.
:::
