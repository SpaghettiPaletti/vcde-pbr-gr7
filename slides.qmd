...
![](pages/images/mikrofacetten_struktur_v6.svg){width=100%}
...
![](pages/images/Fresnel_Effect.jpg){width=100%}
...
- Je flacher der Blickwinkel,
  desto stärker die Spiegelung
- Besonders sichtbar bei Wasser,
  Glas und Metall
:::
...
::: {.fragment style="margin-top:35px; text-align:center; font-size:1.15em;"}
...
- Fresnel-Effekt:
  https://www.keheka.com/fresnel-reflections-in-nuke/
