...
::: {style="display: flex; justify-content: right; align-items: right; gap: 0rem; margin: 1rem 0;"}

::: {style="text-align: right; flex: 0 0 auto;"}
![](images/makroskopisch_v5.svg){width=60%}
:::
...
![](images/mikrofacetten_struktur_v6.svg){width="500px"}
:::
...
<details>
<summary>Welche Rolle spielen die NDF $D$ und der Geometry-Term $G$ in der Cook-Torrance-BRDF?</summary>
...
<details>
<summary>Warum verletzt ein Phong-Material mit `Diffuse = 0.8` und `Specular = 0.8` die Energieerhaltung?</summary>
